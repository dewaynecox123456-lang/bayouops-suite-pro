...
require_path "brand/icons/bayouops-launcher-icon.ico"
...
copy_required_file "brand/icons/bayouops-launcher-icon.ico" "${PACKAGE_DIR}/icons/bayouops-launcher-icon.ico"
...
required_package_paths=(
    ...
    "icons/bayouops-launcher-icon.ico"
